      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded bg-white p-6 shadow">
            ...
            <button onClick={() => navigate('/batches')} className="mt-2 text-sm text-indigo-600 hover:underline">View Batches</button>
          </div>
          <div className="rounded bg-white p-6 shadow">
            <h3 className="text-lg font-semibold">My Students</h3>
            <p className="text-2xl font-bold text-indigo-600">View</p>
            <button onClick={() => navigate('/students')} className="mt-2 text-sm text-indigo-600 hover:underline">View Students</button>
          </div>
          <div className="rounded bg-white p-6 shadow">
          ...
          <div className="rounded bg-white p-6 shadow">
            ...
            <p className="text-2xl font-bold text-indigo-600">Mark</p>
